	...
	do {
		try {
			...
			this.browser = await puppeteer.launch({
				headless: headless,
				args: ['--use-fake-ui-for-media-stream', '--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4691.0 Safari/537.36']
			});
			...
			console.log(lcl.blue("[Browser - Info]"), "Clicked join button");
